...
<body class="text-(--electric-blue) inter-normal h-screen flex flex-col overflow-hidden select-none">
    ...
    <form id="registrationForm" class="flex flex-col flex-1" novalidate>
        ...
        <p id="login-error" class="px-5 py-3 text-sm text-red-600 hidden" role="alert" aria-live="polite"></p>
    </form>
